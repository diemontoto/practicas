...
<title>Múltiple subida de archivos</title>
...
<nav class="navbar navbar-expand-lg fixed-top navbar-dark bg-dark">
   ...
   <!-- <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav">
            <a class="nav-item nav-link active" href="https://www.jose-aguilar.com/scripts/base-bootstrap/">C<span class="sr-only">(current)</span></a>
...
<div class="container">
    <h1>Múltiple subida de archivos</h1>
    <h2 class="lead">Sube aqui tus archivos</h2>
    
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="https://www.jose-aguilar.com/blog/">EET Nº2</a></li>
          <li class="breadcrumb-item"><a href="https://www.jose-aguilar.com/blog/dropzone-multiple-subida-de-archivos-con-bootstrap-y-php/">Prácticas Profesionalizantes</a></li>
...
<form action="index.php" method="post" enctype="multipart/form-data">
    ...
    <div class="dropzone-here">Arrastra los archivos hasta aquí</div>
</form>  
        </div>
    </div>
